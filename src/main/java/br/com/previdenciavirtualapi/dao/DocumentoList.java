...
public class DocumentoList {
  ...
  private DocumentoList() {
    ...
    Map<String, Documento> aux = new HashMap<>();
    String id = UUID.randomUUID().toString();
    aux.put(id, new Documento(CategoriaBeneficiario.IDENTIFICACAO, id,
        "exemplo", "pdf", new Timestamp(System.currentTimeMillis())));
    arquivos.put(id, new Arquivo(id, getBase64()));

    id = UUID.randomUUID().toString();
    aux.put(id, new Documento(CategoriaBeneficiario.IDENTIFICACAO, id,
        "exemplo", "pdf", new Timestamp(System.currentTimeMillis())));
    arquivos.put(id, new Arquivo(id, getBase64()));
    documentos.put("10210210214", aux);
    ...
    id = UUID.randomUUID().toString();
    aux.put(id, new Documento(CategoriaBeneficiario.REMUNERACAO_PROVENTOS, id,
        "exemplo", "pdf", new Timestamp(System.currentTimeMillis())));
    arquivos.put(id, new Arquivo(id, getBase64()));
    documentos.put("01401401425", aux);
    ...
    id = UUID.randomUUID().toString();
    aux.put(id, new Documento(CategoriaBeneficiario.CONTAGEM_DE_TEMPO, id,
        "exemplo", "pdf", new Timestamp(System.currentTimeMillis())));
    arquivos.put(id, new Arquivo(id, getBase64()));
    documentos.put("74174174123", aux);
    ...
    aux.put(id, new Documento(CategoriaBeneficiario.IDENTIFICACAO, id,
        "exemplo", "pdf", new Timestamp(System.currentTimeMillis())));
    arquivos.put(id, new Arquivo(id, getBase64()));
    documentos.put("25825825841", aux);
    ...
    aux.put(id, new Documento(CategoriaBeneficiario.IDENTIFICACAO, id,
        "exemplo", "pdf", new Timestamp(System.currentTimeMillis())));
    arquivos.put(id, new Arquivo(id, getBase64()));
    documentos.put("12315142581", aux);
